...
| minibatch_index | training_aggregation_manifest_t128 | python_semantic_oracle | rust_execute | rejected_as_expected | proof-manifest-chain only; does not recursively verify child proofs inside SP1; reused existing SP1 provenance tamper_report.json |
...
| target_network_sync | training_aggregation_manifest_t128 | python_semantic_oracle | rust_execute | rejected_as_expected | proof-manifest-chain only; does not recursively verify child proofs inside SP1; reused existing SP1 provenance tamper_report.json |
...
| checkpoint_hash | one_step_sgd_tiny, training_aggregation_manifest_t128, training_aggregation_manifest_t32, training_aggregation_manifest_t64, training_fragment_k1, training_fragment_k4, training_fragment_k8, training_update | summary | summary | 15/15 rejected | 0 not_applicable |
| collection_log_final_hash | dataset_commitment, public_dataset_commitment | summary | summary | 1/2 rejected | 1 not_applicable |
| dataset_root | dataset_commitment, merkle_membership, training_aggregation_manifest_t128, training_aggregation_manifest_t32, training_aggregation_manifest_t64, training_update | summary | summary | 9/9 rejected | 0 not_applicable |
...
| manifest_hash | dataset_commitment, training_aggregation_manifest_t128, training_aggregation_manifest_t32, training_aggregation_manifest_t64, training_fragment_k1, training_fragment_k4, training_fragment_k8, training_update | summary | summary | 8/8 rejected | 0 not_applicable |
...
| minibatch_index | merkle_membership, training_aggregation_manifest_t128, training_aggregation_manifest_t32, training_aggregation_manifest_t64, training_fragment_k1, training_fragment_k4, training_fragment_k8, training_update | summary | summary | 23/23 rejected | 0 not_applicable |
...
| proof_public_input | forward_td_mlp, merkle_membership, one_step_sgd_tiny, proof_artifact_policy, td_mvp, training_aggregation_manifest_t128, training_aggregation_manifest_t32, training_aggregation_manifest_t64, training_fragment_k1, training_fragment_k4, training_fragment_k8, training_update | summary | summary | 42/44 rejected | 2 not_applicable |
...
| target_network_sync | training_aggregation_manifest_t128, training_aggregation_manifest_t32, training_aggregation_manifest_t64, training_fragment_k1, training_fragment_k4, training_fragment_k8 | summary | summary | 6/6 rejected | 0 not_applicable |

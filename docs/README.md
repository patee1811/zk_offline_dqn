...
- `giai_thich_toan_dien.md` - onboarding walkthrough in Vietnamese: vocabulary, problem,
  why this stack, architecture, results, honest limits, and a defence Q&A. Start here if
  the project is new to you.

...
```text
real_value â‰ˆ value_fp / fp_scale
```
...
```text
docs/archive/internal_manifests/zk_backend_mvp.md
docs/archive/internal_manifests/threat_model.md
docs/archive/internal_manifests/backend_choice.md
```

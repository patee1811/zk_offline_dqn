...
| Recursive aggregation | no | no | unsupported / future work | The current aggregation proof is proof-manifest-chain mode, not recursive child-proof verification. |

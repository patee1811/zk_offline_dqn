...
computes in \texttt{i64}, so the discount multiplication $\gamma \cdot Q$
leaves the representable range once $|Q|$ passes
$\texttt{i64::MAX} / \gamma \approx 9.3 \times 10^{15}$. Offline DQN can reach

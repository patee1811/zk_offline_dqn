...
\begin{itemize}[leftmargin=1.5em]
  ...
  verifies child proofs cryptographically for $T \in \{16, 32, 64\}$, but only
  under a CUDA prover: peak device memory is $18.4$~GB, and the CPU prover did
  not complete within $61$~GB of host memory. $T = 128$ is untested, and the
  $T \in \{32, 64, 128\}$ rows in Table~2 remain proof-manifest chains.

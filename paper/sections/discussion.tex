...
\begin{itemize}[leftmargin=1.5em]
  ...
  cycles per leaf, against the $6.19$ billion of the largest row we have
  proved.
...
\begin{itemize}[leftmargin=1.5em]
  ...
  specialise for this; the computation is simply absent.
  \item \textbf{No line advances a second model.} Target-network
  synchronisation is a step-indexed event that rewrites the network the labels
...
breakdown gives the following, where ``commitment'' is the cost of committing
to model state rather than of proving any arithmetic on it:

\begin{center}\small
\begin{tabular}{@{}lrr@{}}
\toprule
\textbf{Prover time component} & \textbf{VGG-11 (10.1M)} & \textbf{LeNet (61.7k)} \\
\midrule
...
optimise. We read this as a statement about the current cost regime of

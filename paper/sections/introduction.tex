...
\begin{enumerate}[leftmargin=1.8em]
  ...
  \item \textbf{SP1 proof-backed relations and configurations.} We implement
  ZK relations and generate verified SP1 proofs covering replay membership
  ...
  aggregation for $T \in \{32, 64, 128\}$ steps
  (\Cref{sec:relations,sec:proof-backend,sec:training-fragment}).
  ...
  across 19 adversarial categories with 166 test cases and zero unexpectedly

...
virtual machine, opening the door to \emph{cryptographically} verifiable RL
training. We keep that adjective throughout, because the phrase ``verifiable
...
\begin{enumerate}[leftmargin=1.8em]
  ...
  trained on: $1248$ steps for each environment, and $4{,}992$ steps over

...
Finally, the current artifact has no recursive aggregation. The SP1 proof cost
is still prototype-scale: verification is fast, but proving takes minutes for
the reported TD MVP case. Scaling beyond this scoped relation will require more
efficient neural-network proofs, aggregation or recursion over repeated updates,
and careful treatment of optimizer and sampling semantics.

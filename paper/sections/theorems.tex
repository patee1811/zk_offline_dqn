...
\[
  C_D=(\mathsf{dataset\_root}, \mathsf{manifest\_hash},
  \mathsf{audit\_report\_hash}, \mathsf{raw\_trajectory\_hash},
  \mathsf{collection\_log\_final\_hash}),
\]
where the last field is present for self-collected audited datasets and absent

...
source-integrity checks that were performed. Public Minari/D4RL~\cite{minari2023, fu2020d4rl} benchmark rows are source-integrity commitments,
...
Chains are local; initialisation is an input \\
\midrule

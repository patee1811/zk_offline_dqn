...
def main() -> None:
    ...
    checks = [
        ...
        },
        {
            ...
            "command": [py, "scripts/artifacts_export/verify_short_trace_update_artifact.py"],
            "env": {
                "SHORT_TRACE_ARTIFACT_PATH": "artifacts/fixtures/short_trace/short_trace_seeded_artifact.json",
                "SHORT_TRACE_MERKLE_PATH": "artifacts/fixtures/membership/cartpole_dqn_eps010_merkle.json",
                "SHORT_TRACE_INITIAL_CHECKPOINT_PATH": "models/offline_dqn_with_target_seed42_best.pt",
                "SHORT_TRACE_FINAL_CHECKPOINT_PATH": "artifacts/fixtures/short_trace/short_trace_seeded_work/step_1_post_synced_9_13_15_18.pt",
                "SHORT_TRACE_WORK_DIR": "artifacts/fixtures/short_trace/short_trace_seeded_work",
            },
        },
        {
        ...
        {
            "name": "benchmark_mountaincar_forward_td_sp1_python_only",
            "command": [
                py,

...
from zk_offline_dqn.backends.sp1.short_trace import (
    DEFAULT_CASE_PATH,
    cargo_command,
    load_case,
    run_cargo,
...
PROVENANCE_DIR = Path("artifacts/reports/provenance/sp1/short_trace")
PROVENANCE_FILES = [
    "public_inputs.json",
    "witness_schema.json",
    "metrics.json",
...
class Sp1ShortTraceFixtureTests(unittest.TestCase):
    ...
    def test_cargo_execute_command_shape(self):
        ...
        self.assertIn("short-trace-host", command)
    ...
    def test_committed_provenance_is_complete(self):
        ...
        self.assertEqual(metrics["relation"], "short_trace")

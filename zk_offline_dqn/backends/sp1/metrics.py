...
DEFAULT_SUMMARY_PATHS = (
    Path("artifacts/benchmarks/distinct_td_sp1/summary.json"),
    Path("artifacts/benchmarks/forward_td_mlp_sp1/summary.json"),
    Path("artifacts/benchmarks/one_step_sgd_tiny_sp1/summary.json"),

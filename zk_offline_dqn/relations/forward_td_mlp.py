"""Pure forward-TD MLP test-vector relation checks."""
...
def verify_forward_trace(
    claimed: Dict[str, Any], expected: Dict[str, Any], prefix: str
) -> None:
    assert_equal(
        claimed["pre_activations"],
        expected["pre_activations"],
        f"{prefix}.pre_activations",
    )
